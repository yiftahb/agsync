---
name: cursor-skills
description: Expert in Cursor Agent Skills, the open standard for extending AI agents. Use when creating, editing, or troubleshooting Cursor skills under .agents/skills/ or .cursor/skills/.
