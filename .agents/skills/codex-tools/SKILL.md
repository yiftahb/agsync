---
name: codex-tools
description: Expert in Codex MCP tool configuration and agents/openai.yaml tool dependencies. Use when setting up MCP servers, configuring tools, or troubleshooting Codex tool integrations.
